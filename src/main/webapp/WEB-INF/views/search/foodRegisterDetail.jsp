   ...
   <div class="sub_content"></div>
    ...
    function nutrientShow() {
        const nutrients = [
            ...
            'dietary_fiber', 'calcium', 'ironContent', 'phosphorus', 
        ...
        nutrients.forEach((nutrient, index) => {
            let nutrientValue = food[nutrient];
            let nutrientContent = nutrientValue * foodAmountPer;
            
            $('.nutrient-content').eq(index).text(nutrientValue.toFixed(2));
            $('.nutrient-result').eq(index).text(nutrientContent.toFixed(2));
            $('input[name=nutrient' + (index + 1) + ']').val(nutrientContent.toFixed(2));
        });
    }
