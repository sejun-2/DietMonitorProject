			...
			<div class="wrap">
				<div class="left">
					<div class="snb_wrap web">
						...
						<nav>
							<ul class="snb">
								<li><a href="/foodSearch" class="arrow">영양정보 찾아보기</a>
									<ul>
										<li><a href="/foodSearch" class="on">식품으로 찾아보기</a></li>
									</ul></li>
							</ul>
							<ul class="snb">
								<li><a href="/diet/dailyDiet" class="arrow">섭취식품 등록</a>
									<ul>
										<li><a href="/diet/dailyDiet" class="on">하루섭취 식품 등록</a></li>
									</ul></li>
							</ul>
							<ul class="snb">
								<li><a href="/mypage/accountInfo" class="on arrow">마이페이지</a>
									<ul>
										<li><a href="/mypage/accountInfo">내 정보</a></li>
										<li><a href="/mypage/modifyAccount" class="on">내 정보
												수정</a></li>
										<li><a href="/mypage/dietProgress">나의 하루 섭취 식품</a></li>
										<li><a href="/mypage/dietHistory">나의 영양성분 저장 기록</a></li>
										<li><a href="/diet/dailyDiet">나의 영양성분 일일 권장량</a></li>
										<li><a href="/mypage/nutritionStandard">나의 영양성분 비교분석</a>
										</li>
									</ul>
								</li>
							</ul>
										...
										<div class="sig_inputs">
											...
											<c:if test="${user.memberNo eq 1}">
												...
												<div class="sig_input wrap_s">
													...
													<input type="password" name="pw"
														placeholder="비밀번호를 입력해 주세요" value="${user.pw}">
												...
												<div class="sig_input wrap_s">
													...
													<input type="password" name="chkPw"
														placeholder="비밀번호를 한번 더 입력해 주세요" value="${user.chkPw}">
											...
											<div class="sig_input wrap_s">
												...
												<input type="text" name="nickname"
													placeholder="사용할 닉네임을 입력해 주세요" value="${user.nickname}">
											...
											<div class="sig_input wrap_s">
												<p>
													프로필 선택<span class="red">*</span>
												</p>
												<div class="cc-selector">
													<c:forEach var="i" begin="1" end="9" step="1">
														<c:if test="${user.iconId == i}">
															<input style="display: none;" id="profile${i}"
																type="radio" name="iconId" value="${i}" checked />
														...
														<c:if test="${user.iconId != i}">
															<input style="display: none;" id="profile${i}"
																type="radio" name="iconId" value="${i}" />
															<label class="drinkcard-cc profiles" for="profile${i}">
																<img src="../images/header/profile/profile_${i}.png">
															</label>
														</c:if>
											...
											<div class="sig_input wrap_s">
												...
												<input type="text" name="birth"
													placeholder="생년월일 6자리를 입력해주세요" value="${user.birth}">
											...
											<div class="sig_input wrap_s">
												...
												<div class="wrap_s">
													<span class="mr20"> <input type="radio"
														name="genderId" value="3" id="male"> <label
														for="male">남자</label>
													</span> <span> <input type="radio" name="genderId"
														value="4" id="female"> <label for="female">여자</label>
													</span>
												</div>
											</div>
											...
											<div class="sig_input wrap_s">
												...
												<div class="sig_check_box wrap_s">
													<div>
														<span class="mr20 sig_check"> <input
															type="checkbox" id="pregnant" class="otherCondition">
															<label for="pregnant">임신</label></span> <span
															class="mr20 sig_check"> <input type="checkbox"
															id="lactation" class="otherCondition"> <label
															for="lactation">수유</label></span> <span
