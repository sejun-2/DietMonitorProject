		...
		<div class="inner">
			<div class="sig_inner">
				...
				<button class="common_btn"
					onclick="location.href='/mypage/modifyAccount'">회원정보수정</button>
			</div>
		</div>
	</section>
	...
	<div class="inner">
		<div class="table_inner">
			<table class="new_tbl_board tb01 mb20">
				...
				<tbody>
					<tr style="font-weight: bolder; background-color: beige;">
						<td>기준</td>
						<th>100</th>
						<th>100</th>
						<th>100</th>
					...
					<tr style="font-weight: bolder; background-color: aliceblue;">
						<td>평균</td>
